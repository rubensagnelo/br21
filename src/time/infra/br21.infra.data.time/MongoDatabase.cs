...
namespace dbmongo
{
    ...
    public class MongoDatabase<T> : IMongoDataBase<T> where T : class, new()
    {
        ...
        protected  static string connectionString = "mongodb+srv://usuario1:R7HgJfxrUv2LR2T@cluster0.wvsyy.mongodb.net/DB1?retryWrites=true&w=majority";
        ...
        public T GetOne(Expression<Func<T, bool>> expression, FindOptions findoptions)
        {
            return Collection.Find(expression,findoptions).SingleOrDefault();
        }
